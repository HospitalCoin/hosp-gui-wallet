...
// Copyright (c) 2016-2018 The HospitalCoin developers
...
//  QMessageBox::information(nullptr, QObject::tr("Help"), cmdLineParser.getHelpText());
    QMessageBox *msg = new QMessageBox(QMessageBox::Information, QObject::tr("Help"),
                       ...
                       QMessageBox::Ok, this);
    msg->setInformativeText(tr("More info can be found at www.hospitalcoin.net in Documentation section"));
...
void MainWindow::createTrayIcon()
{
    ...
    QString toolTip = QString(tr("HospitalCoin Wallet %1")).arg(Settings::instance().getVersion());
